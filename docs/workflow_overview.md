...
- Teams notifications are optional, should use webhooks stored outside source control, can use adaptive-card formatting for clearer operational summaries, and can be routed by category plus severity.
